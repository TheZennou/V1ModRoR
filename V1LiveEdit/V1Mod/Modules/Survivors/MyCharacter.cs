...
namespace V1Mod.Modules.Survivors
{
    internal class MyCharacter : SurvivorBase
    {
        internal override string bodyName { get; set; } = "V1";
        ...
        internal override BodyInfo bodyInfo { get; set; } = new BodyInfo
        {
            ...
            armorGrowth = 0f,
            bodyName = "V1Body",
            bodyNameToken = V1Plugin.developerPrefix + "_V1_BODY_NAME",
            bodyColor = Color.red,
            characterPortrait = Modules.Assets.LoadCharacterIcon("V1"),
            ...
            jumpCount = 1,
            maxHealth = 75f,
            subtitleNameToken = V1Plugin.developerPrefix + "_V1_BODY_SUBTITLE",
            podPrefab = Resources.Load<GameObject>("Prefabs/NetworkedObjects/SurvivorPod"),
        };

        internal static Material HenryMat = Modules.Assets.CreateMaterial("matHenry");
        internal static Material V1wingMat = Modules.Assets.CreateMaterial("matV1Wing", 1.75f, Color.white);
        internal static Material V1bodyMat = Modules.Assets.CreateMaterial("matV1Body", 1.5f, Color.white);
        internal static Material V1revolverMat = Modules.Assets.CreateMaterial("matRevolver", 1f, Color.cyan);
        ...
        internal override void InitializeSkills()
        {
            ...
            string prefix = V1Plugin.developerPrefix;

            string str = "ZARKO";
            Skills.AddPrimarySkill(this.bodyPrefab, Skills.CreatePrimarySkillDef(new SerializableEntityStateType(typeof(SkillStates.Pistol)), "Weapon", str + "_V1_BODY_PRIMARY_PISTOL_NAME", str + "_V1_BODY_PRIMARY_PISTOL_DESCRIPTION", Assets.mainAssetBundle.LoadAsset<Sprite>("texPrimaryIcon"), true));
            Skills.AddPrimarySkill(this.bodyPrefab, Skills.CreatePrimarySkillDef(new SerializableEntityStateType(typeof(SkillStates.Revolver)), "Weapon", str + "_V1_BODY_PRIMARY_REVOLVER_NAME", str + "_V1_BODY_PRIMARY_REVOLVER_DESCRIPTION", Assets.mainAssetBundle.LoadAsset<Sprite>("texPrimaryIcon"), true));


            #region Secondary
            SkillDef shootSkillDef = Modules.Skills.CreateSkillDef(new SkillDefInfo
            {
                skillName = prefix + "_V1_BODY_SECONDARY_GUN_NAME",
                skillNameToken = prefix + "_V1_BODY_SECONDARY_GUN_NAME",
                skillDescriptionToken = prefix + "_V1_BODY_SECONDARY_GUN_DESCRIPTION",
                skillIcon = Modules.Assets.mainAssetBundle.LoadAsset<Sprite>("texSecondaryIcon"),
                activationState = new EntityStates.SerializableEntityStateType(typeof(EntityStates.Mage.JetpackOn)),
            ...
            {
                skillName = prefix + "_V1_BODY_UTILITY_SLIDE_NAME",
                skillNameToken = prefix + "_V1_BODY_UTILITY_SLIDE_NAME",
                skillDescriptionToken = prefix + "_V1_BODY_UTILITY_SLIDE_DESCRIPTION",
                skillIcon = Modules.Assets.mainAssetBundle.LoadAsset<Sprite>("texUtilityIcon"),
                activationState = new EntityStates.SerializableEntityStateType(typeof(SkillStates.Slide2)),
                activationStateMachineName = "Slide",
                baseMaxStock = 1,
            ...
            Modules.Skills.AddUtilitySkills(bodyPrefab, SlideSkillDef);
            #endregion

            #region Utility
            SkillDef HookSkillDef = Modules.Skills.CreateSkillDef(new SkillDefInfo
            {
                skillName = prefix + "_V1_BODY_UTILITY_WHIPLASH_NAME",
                skillNameToken = prefix + "_V1_BODY_UTILITY_WHIPLASH_NAME",
                skillDescriptionToken = prefix + "_V1_BODY_UTILITY_WHIPLASH_DESCRIPTION",
                skillIcon = Modules.Assets.mainAssetBundle.LoadAsset<Sprite>("texUtilityIcon"),
                activationState = new EntityStates.SerializableEntityStateType(typeof(SkillStates.Slide2)),
                activationStateMachineName = "Slide",
                baseMaxStock = 1,
            ...
            Modules.Skills.AddUtilitySkills(bodyPrefab, HookSkillDef);
            #endregion

            #region Special
            SkillDef teslaSkillDef = Modules.Skills.CreateSkillDef(new SkillDefInfo
            {
                skillName = prefix + "_V1_BODY_SPECIAL_TESLA_NAME",
                skillNameToken = prefix + "_V1_BODY_SPECIAL_TESLA_NAME",
                skillDescriptionToken = prefix + "_V1_BODY_SPECIAL_TESLA_DESCRIPTION",
                skillIcon = Modules.Assets.mainAssetBundle.LoadAsset<Sprite>("texSpecialIcon"),
                activationState = new EntityStates.SerializableEntityStateType(typeof(SkillStates.Tesla)),
                activationStateMachineName = "Slide",
                baseMaxStock = 1,
            ...
            Modules.Skills.AddSpecialSkills(bodyPrefab, teslaSkillDef);
            #endregion

            #region Passive
            SkillDef OverclockSkillDef = Modules.Skills.CreateSkillDef(new SkillDefInfo
            {
                skillName = prefix + "_V1_BODY_PASSIVE_OVERCLOCK_NAME",
                skillNameToken = prefix + "_V1_BODY_PASSIVE_OVERCLOCK_NAME",
                skillDescriptionToken = prefix + "_V1_BODY_PASSIVE_OVERCLOCK_DESCRIPTION",
                skillIcon = Modules.Assets.mainAssetBundle.LoadAsset<Sprite>("texSpecialIcon"),
                activationState = new EntityStates.SerializableEntityStateType(typeof(EntityStates.Mage.MageCharacterMain)),
                activationStateMachineName = "Jet",
                baseMaxStock = 1,
            ...
            Modules.Skills.AddPassiveSkills(bodyPrefab, OverclockSkillDef);
            #endregion

            #region Passive2
            SkillDef BLOODISFUELSkillDef = Modules.Skills.CreateSkillDef(new SkillDefInfo
            {
                skillName = prefix + "_V1_BODY_PASSIVE_BLOODISFUEL_NAME",
                skillNameToken = prefix + "_V1_BODY_PASSIVE_BLOODISFUEL_NAME",
                skillDescriptionToken = prefix + "_V1_BODY_PASSIVE_BLOODISFUEL_DESCRIPTION",
            ...
            Modules.Skills.AddPassiveSkills(bodyPrefab, BLOODISFUELSkillDef);
            #endregion
        }
        internal override void InitializeSkins()
        {
            ...
            #region DefaultSkin
            SkinDef defaultSkin = Modules.Skins.CreateSkinDef(V1Plugin.developerPrefix + "_V1_BODY_DEFAULT_SKIN_NAME",
            ...
            defaultSkin.meshReplacements = new SkinDef.MeshReplacement[]
            {
                ...
                {
                    mesh = Modules.Assets.mainAssetBundle.LoadAsset<Mesh>("meshRevolver"),
                    renderer = defaultRenderers[0].renderer
                },
                new SkinDef.MeshReplacement
                {
                    mesh = Modules.Assets.mainAssetBundle.LoadAsset<Mesh>("meshV1Wings"),
                    renderer = defaultRenderers[1].renderer
                },
                new SkinDef.MeshReplacement
                {
                    mesh = Modules.Assets.mainAssetBundle.LoadAsset<Mesh>("meshV1"),
            ...
            #region MasterySkin
            Material V2RevolverMat = Modules.Assets.CreateMaterial("matRevolver", 1f, Color.cyan);
            Material V2WingMat = Modules.Assets.CreateMaterial("matV2Wing", 1.75f, Color.white);
            Material V2BodyMat = Modules.Assets.CreateMaterial("matV2Body", 1.5f, Color.white);
            ...
            SkinDef masterySkin = Modules.Skins.CreateSkinDef(V1Plugin.developerPrefix + "_V1_BODY_MASTERY_SKIN_NAME",
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        new ItemDisplayRule
                        {
                            ...
                            followerPrefab = Tools.LoadDisplay("DisplayBugWings"),
                            childName = "Chest",
            ...
            itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
            {
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        ...
                        {
                            ruleType = ItemDisplayRuleType.ParentedPrefab,
                            followerPrefab = Tools.LoadDisplay("DisplayGoldGat"),
childName = "Chest",
            ...
            itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
            {
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        ...
                        {
                            ruleType = ItemDisplayRuleType.ParentedPrefab,
                            followerPrefab = Tools.LoadDisplay("DisplayBFG"),
childName = "Chest",
            ...
            itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
            {
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        ...
                        {
                            ruleType = ItemDisplayRuleType.ParentedPrefab,
                            followerPrefab = Tools.LoadDisplay("DisplayGlasses"),
childName = "Head",
            ...
            itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
            {
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        ...
                        {
                            ruleType = ItemDisplayRuleType.ParentedPrefab,
                            followerPrefab = Tools.LoadDisplay("DisplaySyringeCluster"),
childName = "Chest",
            ...
            itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
            {
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        ...
                        {
                            ruleType = ItemDisplayRuleType.ParentedPrefab,
                            followerPrefab = Tools.LoadDisplay("DisplayBehemoth"),
childName = "Gun",
            ...
            itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
            {
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        ...
                        {
                            ruleType = ItemDisplayRuleType.ParentedPrefab,
                            followerPrefab = Tools.LoadDisplay("DisplayMissileLauncher"),
childName = "Chest",
            ...
            itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
            {
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        ...
                        {
                            ruleType = ItemDisplayRuleType.ParentedPrefab,
                            followerPrefab = Tools.LoadDisplay("DisplayDagger"),
childName = "Chest",
            ...
            itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
            {
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        ...
                        {
                            ruleType = ItemDisplayRuleType.ParentedPrefab,
                            followerPrefab = Tools.LoadDisplay("DisplayHoof"),
childName = "CalfL",
            ...
            itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
            {
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        ...
                        {
                            ruleType = ItemDisplayRuleType.ParentedPrefab,
                            followerPrefab = Tools.LoadDisplay("DisplayUkulele"),
childName = "Chest",
            ...
            itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
            {
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        ...
                        {
                            ruleType = ItemDisplayRuleType.ParentedPrefab,
                            followerPrefab = Tools.LoadDisplay("DisplayMask"),
childName = "Head",
            ...
            itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
            {
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        ...
                        {
                            ruleType = ItemDisplayRuleType.ParentedPrefab,
                            followerPrefab = Tools.LoadDisplay("DisplayMushroom"),
childName = "UpperArmR",
            ...
            itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
            {
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        ...
                        {
                            ruleType = ItemDisplayRuleType.ParentedPrefab,
                            followerPrefab = Tools.LoadDisplay("DisplayWolfPelt"),
childName = "Head",
            ...
            itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
            {
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        ...
                        {
                            ruleType = ItemDisplayRuleType.ParentedPrefab,
                            followerPrefab = Tools.LoadDisplay("DisplayTriTip"),
childName = "Chest",
            ...
            itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
            {
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        ...
                        {
                            ruleType = ItemDisplayRuleType.ParentedPrefab,
                            followerPrefab = Tools.LoadDisplay("DisplayWarbanner"),
childName = "Pelvis",
            ...
            itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
            {
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        ...
                        {
                            ruleType = ItemDisplayRuleType.ParentedPrefab,
                            followerPrefab = Tools.LoadDisplay("DisplayScythe"),
childName = "Chest",
            ...
            itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
            {
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        ...
                        {
                            ruleType = ItemDisplayRuleType.ParentedPrefab,
                            followerPrefab = Tools.LoadDisplay("DisplaySnail"),
childName = "UpperArmL",
            ...
            itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
            {
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        ...
                        {
                            ruleType = ItemDisplayRuleType.ParentedPrefab,
                            followerPrefab = Tools.LoadDisplay("DisplayClover"),
childName = "Gun",
            ...
            itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
            {
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        ...
                        {
                            ruleType = ItemDisplayRuleType.ParentedPrefab,
                            followerPrefab = Tools.LoadDisplay("DisplayAegis"),
childName = "LowerArmL",
            ...
            itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
            {
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        ...
                        {
                            ruleType = ItemDisplayRuleType.ParentedPrefab,
                            followerPrefab = Tools.LoadDisplay("DisplayBoneCrown"),
childName = "Head",
            ...
            itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
            {
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        ...
                        {
                            ruleType = ItemDisplayRuleType.ParentedPrefab,
                            followerPrefab = Tools.LoadDisplay("DisplayPauldron"),
childName = "UpperArmL",
            ...
            itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
            {
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        ...
                        {
                            ruleType = ItemDisplayRuleType.ParentedPrefab,
                            followerPrefab = Tools.LoadDisplay("DisplayBuckler"),
childName = "LowerArmR",
            ...
            itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
            {
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        ...
                        {
                            ruleType = ItemDisplayRuleType.ParentedPrefab,
                            followerPrefab = Tools.LoadDisplay("DisplayIceRing"),
childName = "Gun",
            ...
            itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
            {
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        ...
                        {
                            ruleType = ItemDisplayRuleType.ParentedPrefab,
                            followerPrefab = Tools.LoadDisplay("DisplayFireRing"),
childName = "Gun",
            ...
            itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
            {
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        ...
                        {
                            ruleType = ItemDisplayRuleType.ParentedPrefab,
                            followerPrefab = Tools.LoadDisplay("DisplayAfterburnerShoulderRing"),
                            childName = "UpperArmL",
            ...
            itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
            {
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        ...
                        {
                            ruleType = ItemDisplayRuleType.ParentedPrefab,
                            followerPrefab = Tools.LoadDisplay("DisplayWaxBird"),
childName = "Head",
            ...
            itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
            {
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        ...
                        {
                            ruleType = ItemDisplayRuleType.ParentedPrefab,
                            followerPrefab = Tools.LoadDisplay("DisplayWarhammer"),
childName = "Chest",
            ...
            itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
            {
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        ...
                        {
                            ruleType = ItemDisplayRuleType.ParentedPrefab,
                            followerPrefab = Tools.LoadDisplay("DisplayDiamond"),
childName = "Sword",
            ...
            itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
            {
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        ...
                        {
                            ruleType = ItemDisplayRuleType.ParentedPrefab,
                            followerPrefab = Tools.LoadDisplay("DisplayRepulsionArmorPlate"),
childName = "ThighL",
            ...
            itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
            {
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        ...
                        {
                            ruleType = ItemDisplayRuleType.ParentedPrefab,
                            followerPrefab = Tools.LoadDisplay("DisplayMissileRack"),
childName = "Chest",
            ...
            itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
            {
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        ...
                        {
                            ruleType = ItemDisplayRuleType.ParentedPrefab,
                            followerPrefab = Tools.LoadDisplay("DisplayFeather"),
childName = "LowerArmL",
            ...
            itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
            {
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        ...
                        {
                            ruleType = ItemDisplayRuleType.ParentedPrefab,
                            followerPrefab = Tools.LoadDisplay("DisplayCrowbar"),
childName = "Chest",
            ...
            itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
            {
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        ...
                        {
                            ruleType = ItemDisplayRuleType.ParentedPrefab,
                            followerPrefab = Tools.LoadDisplay("DisplayGravBoots"),
childName = "CalfL",
            ...
            itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
            {
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        ...
                        {
                            ruleType = ItemDisplayRuleType.ParentedPrefab,
                            followerPrefab = Tools.LoadDisplay("DisplayGuillotine"),
childName = "ThighR",
            ...
            itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
            {
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        ...
                        {
                            ruleType = ItemDisplayRuleType.ParentedPrefab,
                            followerPrefab = Tools.LoadDisplay("DisplayBattery"),
childName = "Chest",
            ...
            itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
            {
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        ...
                        {
                            ruleType = ItemDisplayRuleType.ParentedPrefab,
                            followerPrefab = Tools.LoadDisplay("DisplayDevilHorns"),
childName = "Head",
            ...
            itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
            {
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        ...
                        {
                            ruleType = ItemDisplayRuleType.ParentedPrefab,
                            followerPrefab = Tools.LoadDisplay("DisplayInfusion"),
childName = "Pelvis",
            ...
            itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
            {
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        ...
                        {
                            ruleType = ItemDisplayRuleType.ParentedPrefab,
                            followerPrefab = Tools.LoadDisplay("DisplayMedkit"),
childName = "Chest",
            ...
            itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
            {
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        ...
                        {
                            ruleType = ItemDisplayRuleType.ParentedPrefab,
                            followerPrefab = Tools.LoadDisplay("DisplayBandolier"),
childName = "Chest",
            ...
            itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
            {
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        ...
                        {
                            ruleType = ItemDisplayRuleType.ParentedPrefab,
                            followerPrefab = Tools.LoadDisplay("DisplayHook"),
childName = "Chest",
            ...
            itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
            {
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        ...
                        {
                            ruleType = ItemDisplayRuleType.ParentedPrefab,
                            followerPrefab = Tools.LoadDisplay("DisplayGasoline"),
childName = "ThighL",
            ...
            itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
            {
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        ...
                        {
                            ruleType = ItemDisplayRuleType.ParentedPrefab,
                            followerPrefab = Tools.LoadDisplay("DisplayStunGrenade"),
childName = "ThighR",
            ...
            itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
            {
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        ...
                        {
                            ruleType = ItemDisplayRuleType.ParentedPrefab,
                            followerPrefab = Tools.LoadDisplay("DisplayFirework"),
childName = "Muzzle",
            ...
            itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
            {
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        ...
                        {
                            ruleType = ItemDisplayRuleType.ParentedPrefab,
                            followerPrefab = Tools.LoadDisplay("DisplayLunarDagger"),
childName = "Chest",
            ...
            itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
            {
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        ...
                        {
                            ruleType = ItemDisplayRuleType.ParentedPrefab,
                            followerPrefab = Tools.LoadDisplay("DisplayKnurl"),
childName = "LowerArmL",
            ...
            itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
            {
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        ...
                        {
                            ruleType = ItemDisplayRuleType.ParentedPrefab,
                            followerPrefab = Tools.LoadDisplay("DisplayBeetleGland"),
childName = "Chest",
            ...
            itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
            {
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        ...
                        {
                            ruleType = ItemDisplayRuleType.ParentedPrefab,
                            followerPrefab = Tools.LoadDisplay("DisplaySoda"),
childName = "Pelvis",
            ...
            itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
            {
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        ...
                        {
                            ruleType = ItemDisplayRuleType.ParentedPrefab,
                            followerPrefab = Tools.LoadDisplay("DisplayDoubleMag"),
childName = "Gun",
            ...
            itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
            {
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        ...
                        {
                            ruleType = ItemDisplayRuleType.ParentedPrefab,
                            followerPrefab = Tools.LoadDisplay("DisplayStickyBomb"),
childName = "Pelvis",
            ...
            itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
            {
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        ...
                        {
                            ruleType = ItemDisplayRuleType.ParentedPrefab,
                            followerPrefab = Tools.LoadDisplay("DisplayKey"),
childName = "Pelvis",
            ...
            itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
            {
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        ...
                        {
                            ruleType = ItemDisplayRuleType.ParentedPrefab,
                            followerPrefab = Tools.LoadDisplay("DisplayAPRound"),
childName = "Pelvis",
            ...
            itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
            {
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        ...
                        {
                            ruleType = ItemDisplayRuleType.ParentedPrefab,
                            followerPrefab = Tools.LoadDisplay("DisplayBauble"),
childName = "Pelvis",
            ...
            itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
            {
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        ...
                        {
                            ruleType = ItemDisplayRuleType.ParentedPrefab,
                            followerPrefab = Tools.LoadDisplay("DisplayHippo"),
childName = "Chest",
            ...
            itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
            {
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        ...
                        {
                            ruleType = ItemDisplayRuleType.ParentedPrefab,
                            followerPrefab = Tools.LoadDisplay("DisplayBrainstalk"),
childName = "Head",
            ...
            itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
            {
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        ...
                        {
                            ruleType = ItemDisplayRuleType.ParentedPrefab,
                            followerPrefab = Tools.LoadDisplay("DisplayCorpseFlower"),
childName = "UpperArmR",
            ...
            itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
            {
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        ...
                        {
                            ruleType = ItemDisplayRuleType.ParentedPrefab,
                            followerPrefab = Tools.LoadDisplay("DisplayFossil"),
childName = "Chest",
            ...
            itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
            {
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        ...
                        {
                            ruleType = ItemDisplayRuleType.ParentedPrefab,
                            followerPrefab = Tools.LoadDisplay("DisplayAntler"),
childName = "Head",
            ...
            itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
            {
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        ...
                        {
                            ruleType = ItemDisplayRuleType.ParentedPrefab,
                            followerPrefab = Tools.LoadDisplay("DisplayGoldHeart"),
childName = "Chest",
            ...
            itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
            {
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        ...
                        {
                            ruleType = ItemDisplayRuleType.ParentedPrefab,
                            followerPrefab = Tools.LoadDisplay("DisplayBrokenMask"),
childName = "UpperArmR",
            ...
            itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
            {
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        ...
                        {
                            ruleType = ItemDisplayRuleType.ParentedPrefab,
                            followerPrefab = Tools.LoadDisplay("DisplayBrooch"),
childName = "Gun",
            ...
            itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
            {
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        ...
                        {
                            ruleType = ItemDisplayRuleType.ParentedPrefab,
                            followerPrefab = Tools.LoadDisplay("DisplayGlowFlower"),
childName = "UpperArmL",
            ...
            itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
            {
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        ...
                        {
                            ruleType = ItemDisplayRuleType.ParentedPrefab,
                            followerPrefab = Tools.LoadDisplay("DisplayBirdFoot"),
childName = "Head",
            ...
            itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
            {
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        ...
                        {
                            ruleType = ItemDisplayRuleType.ParentedPrefab,
                            followerPrefab = Tools.LoadDisplay("DisplayRazorwireLeft"),
childName = "UpperArmL",
            ...
            itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
            {
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        ...
                        {
                            ruleType = ItemDisplayRuleType.ParentedPrefab,
                            followerPrefab = Tools.LoadDisplay("DisplayBirdEye"),
childName = "Head",
            ...
            itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
            {
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        ...
                        {
                            ruleType = ItemDisplayRuleType.ParentedPrefab,
                            followerPrefab = Tools.LoadDisplay("DisplayJellyGuts"),
childName = "Head",
            ...
            itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
            {
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        ...
                        {
                            ruleType = ItemDisplayRuleType.ParentedPrefab,
                            followerPrefab = Tools.LoadDisplay("DisplayBeads"),
childName = "LowerArmL",
            ...
            itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
            {
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        ...
                        {
                            ruleType = ItemDisplayRuleType.ParentedPrefab,
                            followerPrefab = Tools.LoadDisplay("DisplayInterstellarDeskPlant"),
childName = "UpperArmR",
            ...
            itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
            {
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        ...
                        {
                            ruleType = ItemDisplayRuleType.ParentedPrefab,
                            followerPrefab = Tools.LoadDisplay("DisplayBear"),
childName = "Chest",
            ...
            itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
            {
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        ...
                        {
                            ruleType = ItemDisplayRuleType.ParentedPrefab,
                            followerPrefab = Tools.LoadDisplay("DisplayDeathMark"),
childName = "LowerArmR",
            ...
            itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
            {
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        ...
                        {
                            ruleType = ItemDisplayRuleType.ParentedPrefab,
                            followerPrefab = Tools.LoadDisplay("DisplayWilloWisp"),
childName = "Pelvis",
            ...
            itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
            {
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        ...
                        {
                            ruleType = ItemDisplayRuleType.ParentedPrefab,
                            followerPrefab = Tools.LoadDisplay("DisplaySeed"),
childName = "Head",
            ...
            itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
            {
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        ...
                        {
                            ruleType = ItemDisplayRuleType.ParentedPrefab,
                            followerPrefab = Tools.LoadDisplay("DisplayWhip"),
childName = "Pelvis",
            ...
            itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
            {
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        ...
                        {
                            ruleType = ItemDisplayRuleType.ParentedPrefab,
                            followerPrefab = Tools.LoadDisplay("DisplaySkull"),
childName = "Chest",
            ...
            itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
            {
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        ...
                        {
                            ruleType = ItemDisplayRuleType.ParentedPrefab,
                            followerPrefab = Tools.LoadDisplay("DisplayStealthkit"),
childName = "CalfL",
            ...
            itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
            {
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        ...
                        {
                            ruleType = ItemDisplayRuleType.ParentedPrefab,
                            followerPrefab = Tools.LoadDisplay("DisplayShieldGenerator"),
childName = "Chest",
            ...
            itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
            {
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        ...
                        {
                            ruleType = ItemDisplayRuleType.ParentedPrefab,
                            followerPrefab = Tools.LoadDisplay("DisplayTeslaCoil"),
childName = "Chest",
            ...
            itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
            {
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        ...
                        {
                            ruleType = ItemDisplayRuleType.ParentedPrefab,
                            followerPrefab = Tools.LoadDisplay("DisplayShieldBug"),
childName = "Head",
            ...
            itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
            {
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        ...
                        {
                            ruleType = ItemDisplayRuleType.ParentedPrefab,
                            followerPrefab = Tools.LoadDisplay("DisplayAlienHead"),
childName = "Chest",
            ...
            itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
            {
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        ...
                        {
                            ruleType = ItemDisplayRuleType.ParentedPrefab,
                            followerPrefab = Tools.LoadDisplay("DisplaySkullCrown"),
childName = "Head",
            ...
            itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
            {
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        ...
                        {
                            ruleType = ItemDisplayRuleType.ParentedPrefab,
                            followerPrefab = Tools.LoadDisplay("DisplayWarHorn"),
childName = "Pelvis",
            ...
            itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
            {
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        ...
                        {
                            ruleType = ItemDisplayRuleType.ParentedPrefab,
                            followerPrefab = Tools.LoadDisplay("DisplaySteakCurved"),
childName = "Head",
            ...
            itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
            {
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        ...
                        {
                            ruleType = ItemDisplayRuleType.ParentedPrefab,
                            followerPrefab = Tools.LoadDisplay("DisplayToothMeshLarge"),
childName = "Head",
            ...
            itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
            {
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        ...
                        {
                            ruleType = ItemDisplayRuleType.ParentedPrefab,
                            followerPrefab = Tools.LoadDisplay("DisplayPearl"),
childName = "LowerArmR",
localPos = new Vector3(0F, 0F, 0F),
localAngles = new Vector3(0F, 0F, 0F),
localScale = new Vector3(0.1F, 0.1F, 0.1F),
            ...
            itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
            {
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        ...
                        {
                            ruleType = ItemDisplayRuleType.ParentedPrefab,
                            followerPrefab = Tools.LoadDisplay("DisplayShinyPearl"),
childName = "LowerArmL",
localPos = new Vector3(0F, 0F, 0F),
localAngles = new Vector3(0F, 0F, 0F),
localScale = new Vector3(0.1F, 0.1F, 0.1F),
            ...
            itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
            {
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        ...
                        {
                            ruleType = ItemDisplayRuleType.ParentedPrefab,
                            followerPrefab = Tools.LoadDisplay("DisplayTome"),
childName = "ThighR",
            ...
            itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
            {
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        ...
                        {
                            ruleType = ItemDisplayRuleType.ParentedPrefab,
                            followerPrefab = Tools.LoadDisplay("DisplaySquidTurret"),
childName = "Head",
            ...
            itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
            {
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        ...
                        {
                            ruleType = ItemDisplayRuleType.ParentedPrefab,
                            followerPrefab = Tools.LoadDisplay("DisplayFrostRelic"),
childName = "Base",
            ...
            itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
            {
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        ...
                        {
                            ruleType = ItemDisplayRuleType.ParentedPrefab,
                            followerPrefab = Tools.LoadDisplay("DisplayTalisman"),
childName = "Base",
            ...
            itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
            {
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        ...
                        {
                            ruleType = ItemDisplayRuleType.ParentedPrefab,
                            followerPrefab = Tools.LoadDisplay("DisplayLaserTurbine"),
childName = "Chest",
            ...
            itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
            {
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        ...
                        {
                            ruleType = ItemDisplayRuleType.ParentedPrefab,
                            followerPrefab = Tools.LoadDisplay("DisplayFocusedConvergence"),
childName = "Base",
            ...
            itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
            {
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        ...
                        {
                            ruleType = ItemDisplayRuleType.ParentedPrefab,
                            followerPrefab = Tools.LoadDisplay("DisplayAncestralIncubator"),
childName = "Chest",
            ...
            itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
            {
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        ...
                        {
                            ruleType = ItemDisplayRuleType.ParentedPrefab,
                            followerPrefab = Tools.LoadDisplay("DisplayFireballsOnHit"),
childName = "LowerArmL",
            ...
            itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
            {
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        ...
                        {
                            ruleType = ItemDisplayRuleType.ParentedPrefab,
                            followerPrefab = Tools.LoadDisplay("DisplaySiphonOnLowHealth"),
childName = "Pelvis",
            ...
            itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
            {
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        ...
                        {
                            ruleType = ItemDisplayRuleType.ParentedPrefab,
                            followerPrefab = Tools.LoadDisplay("DisplayBleedOnHitAndExplode"),
childName = "ThighR",
            ...
            itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
            {
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        ...
                        {
                            ruleType = ItemDisplayRuleType.ParentedPrefab,
                            followerPrefab = Tools.LoadDisplay("DisplayMonstersOnShrineUse"),
childName = "ThighR",
            ...
            itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
            {
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        ...
                        {
                            ruleType = ItemDisplayRuleType.ParentedPrefab,
                            followerPrefab = Tools.LoadDisplay("DisplayRandomDamageZone"),
childName = "LowerArmL",
            ...
            itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
            {
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        ...
                        {
                            ruleType = ItemDisplayRuleType.ParentedPrefab,
                            followerPrefab = Tools.LoadDisplay("DisplayFruit"),
childName = "Chest",
            ...
            itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
            {
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        ...
                        {
                            ruleType = ItemDisplayRuleType.ParentedPrefab,
                            followerPrefab = Tools.LoadDisplay("DisplayEliteHorn"),
childName = "Head",
            ...
            itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
            {
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        ...
                        {
                            ruleType = ItemDisplayRuleType.ParentedPrefab,
                            followerPrefab = Tools.LoadDisplay("DisplayEliteRhinoHorn"),
childName = "Head",
            ...
            itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
            {
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        ...
                        {
                            ruleType = ItemDisplayRuleType.ParentedPrefab,
                            followerPrefab = Tools.LoadDisplay("DisplayEliteIceCrown"),
childName = "Head",
            ...
            itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
            {
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        ...
                        {
                            ruleType = ItemDisplayRuleType.ParentedPrefab,
                            followerPrefab = Tools.LoadDisplay("DisplayEliteUrchinCrown"),
childName = "Head",
            ...
            itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
            {
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        ...
                        {
                            ruleType = ItemDisplayRuleType.ParentedPrefab,
                            followerPrefab = Tools.LoadDisplay("DisplayEliteStealthCrown"),
childName = "Head",
            ...
            itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
            {
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        ...
                        {
                            ruleType = ItemDisplayRuleType.ParentedPrefab,
                            followerPrefab = Tools.LoadDisplay("DisplayNeuralImplant"),
childName = "Head",
            ...
            itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
            {
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        ...
                        {
                            ruleType = ItemDisplayRuleType.ParentedPrefab,
                            followerPrefab = Tools.LoadDisplay("DisplayRadio"),
childName = "Pelvis",
            ...
            itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
            {
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        ...
                        {
                            ruleType = ItemDisplayRuleType.ParentedPrefab,
                            followerPrefab = Tools.LoadDisplay("DisplayLightningArmRight"),
childName = "UpperArmR",
localPos = new Vector3(0F, 0F, 0F),
localAngles = new Vector3(0F, 0F, 0F),
            ...
            itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
            {
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        ...
                        {
                            ruleType = ItemDisplayRuleType.ParentedPrefab,
                            followerPrefab = Tools.LoadDisplay("DisplayPotion"),
childName = "Pelvis",
            ...
            itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
            {
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        ...
                        {
                            ruleType = ItemDisplayRuleType.ParentedPrefab,
                            followerPrefab = Tools.LoadDisplay("DisplayEffigy"),
childName = "Pelvis",
            ...
            itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
            {
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        ...
                        {
                            ruleType = ItemDisplayRuleType.ParentedPrefab,
                            followerPrefab = Tools.LoadDisplay("DisplayBatteryArray"),
childName = "Chest",
            ...
            itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
            {
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        ...
                        {
                            ruleType = ItemDisplayRuleType.ParentedPrefab,
                            followerPrefab = Tools.LoadDisplay("DisplayElephantFigure"),
childName = "CalfR",
            ...
            itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
            {
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        ...
                        {
                            ruleType = ItemDisplayRuleType.ParentedPrefab,
                            followerPrefab = Tools.LoadDisplay("DisplayRecycler"),
childName = "Chest",
            ...
            itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
            {
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        ...
                        {
                            ruleType = ItemDisplayRuleType.ParentedPrefab,
                            followerPrefab = Tools.LoadDisplay("DisplayEgg"),
childName = "Pelvis",
            ...
            itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
            {
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        ...
                        {
                            ruleType = ItemDisplayRuleType.ParentedPrefab,
                            followerPrefab = Tools.LoadDisplay("DisplayWaterPack"),
childName = "Chest",
            ...
            itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
            {
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        ...
                        {
                            ruleType = ItemDisplayRuleType.ParentedPrefab,
                            followerPrefab = Tools.LoadDisplay("DisplayTonic"),
childName = "Pelvis",
            ...
            itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
            {
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        ...
                        {
                            ruleType = ItemDisplayRuleType.ParentedPrefab,
                            followerPrefab = Tools.LoadDisplay("DisplayVase"),
childName = "Pelvis",
            ...
            itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
            {
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        ...
                        {
                            ruleType = ItemDisplayRuleType.ParentedPrefab,
                            followerPrefab = Tools.LoadDisplay("DisplayMeteor"),
childName = "Base",
            ...
            itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
            {
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        ...
                        {
                            ruleType = ItemDisplayRuleType.ParentedPrefab,
                            followerPrefab = Tools.LoadDisplay("DisplaySawmerang"),
childName = "Base",
localPos = new Vector3(0F, -1.7606F, -0.9431F),
localAngles = new Vector3(0F, 0F, 0F),
localScale = new Vector3(0.1F, 0.1F, 0.1F),
            ...
            itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
            {
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        ...
                        {
                            ruleType = ItemDisplayRuleType.ParentedPrefab,
                            followerPrefab = Tools.LoadDisplay("DisplayGravCube"),
childName = "Base",
localPos = new Vector3(0F, -1.7606F, -0.9431F),
localAngles = new Vector3(0F, 0F, 0F),
            ...
            itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
            {
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        ...
                        {
                            ruleType = ItemDisplayRuleType.ParentedPrefab,
                            followerPrefab = Tools.LoadDisplay("DisplayScanner"),
childName = "Pelvis",
            ...
            itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
            {
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        ...
                        {
                            ruleType = ItemDisplayRuleType.ParentedPrefab,
                            followerPrefab = Tools.LoadDisplay("DisplayDeathProjectile"),
childName = "Pelvis",
            ...
            itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
            {
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        ...
                        {
                            ruleType = ItemDisplayRuleType.ParentedPrefab,
                            followerPrefab = Tools.LoadDisplay("DisplayLifestealOnHit"),
childName = "Head",
            ...
            itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
            {
                ...
                displayRuleGroup = new DisplayRuleGroup
                {
                    rules = new ItemDisplayRule[]
                    {
                        ...
                        {
                            ruleType = ItemDisplayRuleType.ParentedPrefab,
                            followerPrefab = Tools.LoadDisplay("DisplayTeamWarCry"),
childName = "Pelvis",
