...
namespace V1Mod.Modules
{
    internal static class Assets
    {
        ...
        // CHANGE THIS
        private const string assetbundleName = "V1assetbundle";
        ...
        internal static void LoadAssetBundle()
        {
            ...
            {
                using (var assetStream = Assembly.GetExecutingAssembly().GetManifestResourceStream("V1Mod." + assetbundleName))
                {
        ...
        {
            using (Stream manifestResourceStream2 = Assembly.GetExecutingAssembly().GetManifestResourceStream("V1Mod.HenryBank.bnk"))
            {
        ...
        internal static void LoadSoundbank2()
        {
            using (Stream manifestResourceStream2 = Assembly.GetExecutingAssembly().GetManifestResourceStream("V1Mod.V1SoundBank.bnk"))
            {
                byte[] array = new byte[manifestResourceStream2.Length];
                manifestResourceStream2.Read(array, 0, array.Length);
                SoundAPI.SoundBanks.Add(array);
