...
namespace V1Mod.Modules
{
    ...
    internal static class Prefabs
    {
        ...
        {
            string fullNameString = V1Plugin.developerPrefix + "_" + namePrefix + "_BODY_NAME";
            string fullDescString = V1Plugin.developerPrefix + "_" + namePrefix + "_BODY_DESCRIPTION";
            string fullOutroString = V1Plugin.developerPrefix + "_" + namePrefix + "_BODY_OUTRO_FLAVOR";
            string fullFailureString = V1Plugin.developerPrefix + "_" + namePrefix + "_BODY_OUTRO_FAILURE";
        ...
        {
            V1Plugin.DestroyImmediate(main.transform.Find("ModelBase").gameObject);
            V1Plugin.DestroyImmediate(main.transform.Find("CameraPivot").gameObject);
            V1Plugin.DestroyImmediate(main.transform.Find("AimOrigin").gameObject);
